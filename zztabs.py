...
t10font = "32"
t11font = "39"
in_filename = r'E:\PoE Stuff\Filters\1\exp\00_user_settings.txt'
...
def initialize():
    global t1font, t1value, t2font, t2value, t3font, t3value, t4font, t4value, t5font, t5value, t6font, t6value, t7font, t7value, t8font, t8value, t9font, t9value, t10font, t11font
    global e12, e13, e22, e23, e32, e33, e42, e43, e52, e53, e62, e63, e72, e73, e82, e83, e92, e93, e102, e112, booUSFexists
    ...
    if os.path.isfile(in_filename):
        ...
        with open(r'E:\PoE Stuff\Filters\1\exp\00_user_settings.txt', 'r') as f:
            for line in f:
                # Get values Get values Get values Get values Get values Get values Get values Get values
                if "t1value: " in line:
...
def save_values():
    ...
    with open('00_user_settings.txt', 'w') as f:
...
# form > tab_parent > tab# > frame# > row# > entry#
initialize()
...
label03 = Label(frame03, justify='left', text="Set breakpoint for Unique items that share a common base (aka \"Tier 11\", or \"Gray items\"):\r(See instructions, as this can have three different effects based on how you set it.)\rTHIS FEATURE DOES NOT WORK YET.")
...
if booUSFexists == False:
    print ("User Settings file not present. Creating a new one using default values.")
    save_values()
