...
def func_init():
    ...
    with open(strTXTout, 'w', newline='') as write_obj:
        ...
        write_obj.write("##### \n")
        write_obj.write("##### My eventual goal is to enable you to run the Python scripts that build these filters from your own PC whenever\n")
        write_obj.write("##### you want to get updated pricing!  You can find the code at the Github page above, but if you don't want to\n")
        write_obj.write("##### install Python or run the code yourself you can just download the filters I make with it and use them like so:\n")
        write_obj.write("#####\n")
        write_obj.write("##### 1) Check for updates once a month or at least before new leagues to get the latest update.\n")
        write_obj.write("##### 2) Paste this file into the following folder: %userprofile%/Documents/My Games/Path of Exile\n")
        write_obj.write("##### 3) IN GAME: Escape -> Options -> UI -> Scroll down -> Select the filter from the Dropdown box\n")
        write_obj.write("#===============================================================================================================\n")
