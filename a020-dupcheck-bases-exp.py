...
out_filename = r'E:\PoE Stuff\Filters\1\exp\020_dup_bases_removed.csv'

important_cols = ["category","baseType","variant","levelRequired","links"]
ignore_dict = {"category" : ["beast","clus","curr","deli","div","ench","ess","foss","frag","gem","inc","inv","oil","prop","res","scar","uacc","uarm","ufla","ujew","umap","uweap","vial","watch","map","blight"]}
...
print('Checking item base duplicates')
print('Done!')
